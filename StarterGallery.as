package {
	...
	public class StarterGallery extends MovieClip {
		var myFlxerGallery;
		var cnt
		var myLoader
		public var home;
		...
		public function StarterGallery() {
		...
		public function avviaJs() {
			...
			if (!cnt) {
				// multifoto + video
				cnt = "http://dev.flxer.net/_fp/fpGallery.php?id=p6152";
				// solo video
			...
			if (tmp2 == "flv" || tmp2 == "mp3" || tmp2 == "swf" || tmp2 == "jpg" || tmp2 == "png" || tmp2 == "gif") {
				...
				if (tmp[2]) {
					this.myFlxerGallery.mySuperPlayer.monitor.addEventListener(MouseEvent.MOUSE_DOWN, navigateToURL(new URLRequest(Preferences.pref.myPath+Preferences.pref.myUserPath+tmp[2]),"_self"));
				}
